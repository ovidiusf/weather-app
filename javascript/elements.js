// exporting the DOM elements that we need for the app
export const SEARCH_BUTTON = document.querySelector('button');
export const SEARCHED_CITY = document.querySelector('#city');
...
export const WEATHER_TEMPERATURE = document.querySelector('#weatherTemperature');
